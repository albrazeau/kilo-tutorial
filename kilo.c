...
left off at https://viewsourcecode.org/snaptoken/kilo/04.aTextViewer.html#limit-scrolling-to-the-right
*/

/*** includes ***/

//added above our includes because the header files being
//included use the macros to decide which features to expose
...
enum editorKey {
    // add special keys for scrolling/ input
    // enum sets the first var to 1000, then each goes up by 1
    // 1001, 1002, 1003...
    ARROW_LEFT = 1000,
    ARROW_RIGHT,
    ARROW_UP,
...
struct editorConfig {
    ...
    int rowoff; // allows for vertical scrolling
    int coloff; // allows for horizontal scrolling
    int screenrows; // number of rows in the terminal
    int screencols; // number of cols in the terminal
    int numrows;
    erow *row;
